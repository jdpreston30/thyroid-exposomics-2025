...
F1_S1_CP2227_R <- vp(F1_S1_CP2227, yl = -2.6e6, yu = 1e6, xl = 9.06, xu = 9.2, save_grob = TRUE)
...
#- 9.3.18: 2,4-Dimethylphenol (CP2237)
...
#+ 9.6: Skip entire section if YAML specifies
} else {
