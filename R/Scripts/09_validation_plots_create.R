...
#- 9.3.18: o-Toluidine (CP3017)
F3_S2_CP3017_R <- vp(F3_S2_CP3017, xl = 8.0, xu = 8.15)
F3_S2_CP3017_RF <- vp(F3_S2_CP3017_R, mz_fragment = 2)
#- 9.3.19: o-Cresol (CP3066)
F2_S2_CP3066_R <- vp(F2_S2_CP3066, xl = 7.3, xu = 7.475, yl = 1.5e7, yu = -1.5e7)
F2_S2_CP3066_RF <- vp(F2_S2_CP3066_R, mz_fragment = -4)
#- 9.3.20: Fluoranthene (CP2227)
