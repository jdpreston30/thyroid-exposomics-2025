...
# Level 1 quality was considered co-elution of 2 or more fragments of standard and sample within a reasonable time of each other. Far far spread in time was not considered a pass but close co-elution that could be reasonably explained by matrix effects was. Note that there were select cases where the quantitative fragment (asterisk, see below) could not be seen in the standard but could be seen in the sample, and the standard and sample had other co-eluting fragments. These were still considered level 1.
...
#+ 9.2: Blank Plot for a Placeholder
...
#+ 9.4: SF 2.1 (Variant Differences, Level 1)
#- 9.4.1: o-Toluidine (CP3017)
...
#- 9.4.18: 2,4-Dimethylphenol (CP2237)
...
#+ 9.6: SF 3.1 (IARC, Level 1)
#- 9.6.1: o-Toluidine (CP3017)
# Already run above in 9.4.1
#- 9.6.2: Pentachlorophenol (CP1016)
...
#- 9.6.4: Phenacetin (CP2545)
F6_S2_CP2545_R <- vp(F6_S2_CP2545, yl = -2e5, yu = 5e5, xl =6.075, xu = 6.2)
#+ 9.7: SF 3.2 (IARC, Level 2)
#- 9.7.1: 2-Naphthylamine (CP2535)
...
#+ 9.9: SF 3.2 (IARC, Level 2; Cadaver)
#- 9.9.1: 4-ABP (CP3002)
...
#+ 9.10: IARC 1 Top Fragments
#! May not need to if PDF looks ok
#+ 9.11: Skip Entire Section If YAML Specifies
} else {
